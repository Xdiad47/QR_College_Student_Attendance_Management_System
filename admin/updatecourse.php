 ...
 header("Location:../index.php");
  ...
  $executequery = mysqli_query($conn, $query);
    ...
    if(isset ($_POST['updatecourse'])){
        ...
        $update = "UPDATE course SET course_name = '$c_name' where course_id=$id ";
            if (mysqli_query($conn, $update)) {
                ?>
               <script type="text/javascript">
                        
                    if(confirm("course Update Successfully")){
...
<form method="POST" action="">
    <tbody>
    <input hidden  type="text" name="c_id"  class="form-control" readonly value="<?php echo $id; ?>"/></br>
    <input type="text" name="c_name"  class="form-control" value="<?php echo $name; ?>" /></br></br>

    <div id="update" align="right">
    <input type="submit" class="btn btn-primary" name="updatecourse" value="update" >
